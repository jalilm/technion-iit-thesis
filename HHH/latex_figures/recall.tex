\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption[Recall of HHH algorithms as function of available counters]{The Recall of the algorithms for various number of counters on CAIDA'16 and CAIDA'18 traces.}
    \label{fig:recall}
\end{figure}